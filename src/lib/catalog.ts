...
export const CATEGORIES: Category[] = [
  {
    id: "match",
    label: "Match",
    description: "Jersey, shorts, full kit — what they wear when the whistle blows.",
    hero: heroKit,
  },
  {
    id: "sideline",
    label: "Sideline",
    description: "Dresses, hoops, hats — for standing outside in November.",
    hero: heroSpirit,
  },
  {
    id: "warmups",
    label: "Warmups",
    description: "Long sleeve, quarter-zip, sweats — before the whistle.",
    hero: heroCrew,
  },
  {
    id: "alumni",
    label: "Alumni",
    description: "1936 crew and off-field shorts. The year sits where they can see it.",
    hero: heroField,
  },
];
...
export const PRODUCTS: CatalogProduct[] = [
  {
    ...
    name: "Match Jersey",
    blurb:
      "Black V-neck and cuffs. Garnet field. Black chest panel with BAYONNE. Crest left. You type the name and number — they print on the back.",
    category: "match",
    price: 58,
    shopifyItem: "top",
    customizable: true,
  ...
  },
  {
    ...
    name: "Match Shorts",
    blurb: "Same garnet as the jersey. Chevron side panels. Bee on the left leg. No name or number.",
    category: "match",
    price: 34,
    shopifyItem: "bottom",
    customizable: true,
  ...
  },
  {
    ...
    name: "Full Kit Set",
    blurb:
      "Black-collar jersey and matching shorts in one order. One garnet. One crest. Name and number on the jersey.",
    category: "match",
    price: 89,
    shopifyItem: "set",
    customizable: true,
  ...
  },
  {
    ...
    name: "Hoops Jersey",
    blurb: "Black mesh. Garnet-and-white trim. Bee crest left. Name and number on the back.",
    category: "sideline",
    price: 52,
    customizable: true,
    nameNumber: true,
  ...
  },
  {
    ...
    name: "Jersey Dress",
    blurb: "One-piece sideline cut. Basketball crest on the chest. Name and number on the back.",
    category: "sideline",
    price: 72,
    customizable: true,
    nameNumber: true,
  ...
  },
  {
    ...
    name: "AOP Hat",
    blurb: "Honeycomb all over the crown. Boxing-bee crest up front. Front and side views.",
    category: "sideline",
    price: 36,
    customizable: true,
    nameNumber: false,
  ...
  },
  {
    ...
    name: "1936 Crewneck",
    blurb: "Garnet body. Black chevron side panels. Crowned bee on the chest. The year the school opened — no name or number.",
    category: "alumni",
    price: 64,
    customizable: true,
    nameNumber: false,
  ...
  },
  {
    ...
    blurb: "Black base. Garnet chevron side panels. Boxing-bee crest on the left thigh. No name or number.",
    category: "warmups",
    price: 58,
    customizable: true,
    nameNumber: false,
  ...
  },
  {
    ...
    blurb: "Long sleeve for cold nights. Name and number on the back. Year inside the collar.",
    category: "warmups",
    price: 62,
    customizable: true,
    nameNumber: true,
  ...
  },
  {
    ...
    name: "Quarter-Zip",
    blurb: "Bee crest on the left chest. Nothing else on the front. Zip when warmups start.",
    category: "warmups",
    price: 68,
    customizable: true,
    nameNumber: false,
  ...
  },
  {
    ...
    name: "Alumni Shorts",
    blurb: "Same garnet as the match strip. Chevron side panels. Off the field.",
    category: "alumni",
    price: 42,
    customizable: true,
    nameNumber: false,
