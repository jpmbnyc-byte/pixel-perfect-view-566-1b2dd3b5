# Original studio / flat masters

PNG masters for Alumni heritage products (and crest-cap references).
Do not import these from app code — commerce plates resolve through
[`src/lib/brandAssets.ts`](../../../lib/brandAssets.ts).
