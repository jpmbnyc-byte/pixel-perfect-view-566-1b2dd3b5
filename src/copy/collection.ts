...
export const PRODUCT_COPY: Record<string, ProductCopy> = {
  ...
  "performance-ls-mens": {
    tagline: "Built to move.",
    line: "Technical knit · Black · Men’s cut",
    body: "Lightweight technical long sleeve in the men’s cut — straight body, longer sleeve, full chest room. Chest mark in white. Gothic B at the cuff. Sized S–2XL.",
    card: "Technical long sleeve, men’s cut, in black.",
    cta: "Choose your size →",
    confirm: "I’ve checked my size. I understand made-to-order pieces can’t be changed after checkout.",
  },
  "performance-ls-womens": {
    tagline: "Cut for movement.",
    line: "Technical knit · Black · Women’s cut",
    body: "The same technical long sleeve graded on the women’s cut — shorter body, shaped through the waist, narrower shoulder and sleeve. Chest mark in white. Gothic B at the cuff. Sized XS–XL.",
    card: "Technical long sleeve, women’s cut, in black.",
    cta: "Choose your size →",
    confirm: "I’ve checked my size. I understand made-to-order pieces can’t be changed after checkout.",
  },
  "performance-short-mens": {
    tagline: "Seven inches. No extra noise.",
    line: "Technical knit · Black · Men’s cut",
    body: "Seven-inch training short in the men’s cut, with a straight leg, deeper pockets and a longer rise. 07002 on one leg. Gothic B on the other. Sized S–2XL.",
    card: "Seven-inch training short, men’s cut, in black.",
    cta: "Choose your size →",
    confirm: "I’ve checked my size. I understand made-to-order pieces can’t be changed after checkout.",
  },
  "performance-short-womens": {
    tagline: "Five and a half. Cut clean.",
    line: "Technical knit · Black · Women’s cut",
    body: "Training short on the women’s cut — shorter inseam, contoured waistband and a higher rise. 07002 on one leg. Gothic B on the other. Sized XS–XL.",
    card: "Training short, women’s cut, in black.",
    cta: "Choose your size →",
    confirm: "I’ve checked my size. I understand made-to-order pieces can’t be changed after checkout.",
  },
  "performance-set-mens": {
    tagline: "One training uniform.",
    line: "Long sleeve + short · Black · Men’s cut",
    body: "The men’s Performance Long Sleeve and training short together as one uniform. Both pieces in the men’s grade, S–2XL.",
    card: "The training uniform in the men’s cut: long sleeve and short.",
    cta: "Shop the set →",
    confirm: "I’ve checked my size. I understand made-to-order pieces can’t be changed after checkout.",
  },
  "performance-set-womens": {
    tagline: "One training uniform.",
    line: "Long sleeve + short · Black · Women’s cut",
    body: "The women’s Performance Long Sleeve and training short together as one uniform. Both pieces in the women’s grade, XS–XL.",
    card: "The training uniform in the women’s cut: long sleeve and short.",
    cta: "Shop the set →",
    confirm: "I’ve checked my size. I understand made-to-order pieces can’t be changed after checkout.",
  },
  "mens-raglan": {
