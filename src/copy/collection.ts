...
export const PRODUCT_COPY: Record<string, ProductCopy> = {
  ...
  "sideline-shell": {
    tagline: "Light weather layer.",
    line: "Lightweight shell · Black",
    body: "Packable lightweight shell with a water-resistant polyester body, zip front, mesh-lined three-panel hood and welt pockets. A sideline layer for wind, light rain and the walk to the field.",
    card: "Packable lightweight water-resistant shell with a mesh-lined hood and welt pockets.",
    cta: "Choose your size →",
    confirm: "I’ve checked my size. I understand made-to-order pieces can’t be changed after checkout.",
  },
  "two-tone-cap": {
...
> = {
  ...
  travel: {
    ...
    body: "Heavyweight layers, collegiate basics and utility pieces made for transit, recovery and repeat wear.",
    cta: "Shop Travel + Core →",
  },
  harbor: {
    line: "Harbor Division",
    title: "Built on water.",
    body: "Outerwear shaped by the industrial edge of the city: black coach shell, lightweight sideline layer, quiet fronts and weather-ready construction.",
