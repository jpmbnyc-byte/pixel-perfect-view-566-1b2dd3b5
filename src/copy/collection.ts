...
export const PRODUCT_COPY: Record<string, ProductCopy> = {
  "heritage-jersey": {
    ...
    personalizeHelper: "Number on the front and back. Name across the back. Same digits, same font. Letters, spaces, hyphens and apostrophes. Leave both blank for the $78 club jersey.",
  ...
  "harbor-sweatpant-black": {
    ...
    line: "8 oz fleece · Black / Garnet",
    body: "Black Harbor Division fleece cut from 8 oz ringspun 60/40 cotton-polyester athletic fleece. Covered 1.5-inch elastic waistband, two side-seam pockets, and an open bottom with a double-needle hem. Relaxed unisex athletic fit — soft mid-weight coverage for travel and warmups. Small garnet BAYONNE ATHLETICS 07002 on the left thigh.",
    card: "Black 8 oz Harbor Division fleece with a garnet 07002 thigh mark.",
    cta: "Choose your size →",
    confirm: "I’ve checked my size. I understand made-to-order pieces can’t be changed after checkout.",
  },
  "harbor-sweatpant-grey": {
    tagline: "Harbor fleece, heather.",
    line: "8 oz fleece · Heather Grey / Garnet",
    body: "Heather grey Harbor Division fleece cut from 8 oz ringspun 60/40 cotton-polyester athletic fleece. Covered 1.5-inch elastic waistband, two side-seam pockets, and an open bottom with a double-needle hem. Relaxed unisex athletic fit — soft mid-weight coverage for travel and warmups. Small garnet BAYONNE ATHLETICS 07002 on the left thigh.",
    card: "Heather grey 8 oz Harbor Division fleece with a garnet 07002 thigh mark.",
    cta: "Choose your size →",
    confirm: "I’ve checked my size. I understand made-to-order pieces can’t be changed after checkout.",
  },
  "two-tone-cap": {
