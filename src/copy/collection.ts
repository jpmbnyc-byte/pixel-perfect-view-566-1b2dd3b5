...
export const PRODUCT_COPY: Record<string, ProductCopy> = {
  ...
  "nb-bbp400": {
    ...
    body: "The P400 in Cloud Blue / White. Dual cushioning — EVA with a Fresh Foam X core — a molded upper and a lightweight nylon plate for stops, cuts and landings. Unisex last; sizes on the page are the pairs on the floor.",
    card: "Cloud Blue P400. Dual cushioning and a nylon plate, in the sizes we actually have.",
  ...
  "nb-runner": {
    ...
    body: "The AC Runner in Black / Afterglow. Fresh Foam X in three densities, firm rails for lateral work, mesh upper, sculpted midsole. Men’s sizing with women’s conversion on the size buttons — only the sizes in stock.",
    card: "Black / Afterglow AC Runner. Fresh Foam X, in the sizes we actually have.",
    cta: "Choose your pair →",
    confirm: "I’ve checked my size. I understand this pair can’t be changed after checkout.",
  },
};
