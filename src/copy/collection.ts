...
export const PRODUCT_COPY: Record<string, ProductCopy> = {
  ...
  "nb-bbp400": {
    ...
    line: "Textile / synthetic · Cloud Blue / White",
    body: "The P400 in Cloud Blue / White. Dual cushioning — EVA with a Fresh Foam X core — a molded upper and a lightweight nylon plate. Unisex last; the size on the page is the pair on the floor.",
    card: "Cloud Blue P400. Dual cushioning and a nylon plate, in the size we actually have.",
  ...
  "nb-p400-chalk": {
    ...
    body: "The P400 in Pink Chalk / White. Dual cushioning — EVA with a Fresh Foam X core — a molded upper and a lightweight nylon plate. Unisex last; the size on the page is the pair on the floor.",
    card: "Pink Chalk P400. Dual cushioning and a nylon plate, in the size we actually have.",
    cta: "Choose your pair →",
    confirm: "I’ve checked my size. I understand this pair can’t be changed after checkout.",
  },
  "nb-p400-volt": {
    ...
    body: "The P400 in Afterglow. Dual cushioning — EVA with a Fresh Foam X core — a molded upper and a lightweight nylon plate. Unisex last; the size on the page is the pair on the floor.",
    card: "Afterglow P400. Dual cushioning and a nylon plate, in the size we actually have.",
    cta: "Choose your pair →",
    confirm: "I’ve checked my size. I understand this pair can’t be changed after checkout.",
  },
  "nb-runner": {
    tagline: "Daily miles.",
    line: "Mesh · Black / Afterglow",
    body: "The AC Runner in Black / Afterglow. Fresh Foam X in three densities, firm rails for lateral work, mesh upper, sculpted midsole. Men’s sizing with women’s conversion on the size buttons — only the size in stock.",
    card: "Black / Afterglow AC Runner. Fresh Foam X, in the size we actually have.",
    cta: "Choose your pair →",
    confirm: "I’ve checked my size. I understand this pair can’t be changed after checkout.",
  },
  "nb-runner-heat": {
