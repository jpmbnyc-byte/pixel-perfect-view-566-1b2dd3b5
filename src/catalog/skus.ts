...
const DRAFTS: Draft[] = [
  ...
  },
  {
    ...
    block: "crest-cap-v1",
    mode: "none",
    blurb: "Bone pinstripe crown. Garnet brim. BB crest front. Bee on the side. S/M · L/XL.",
    plateFront: "aop-hat",
    plateSecondary: "aop-hat",
    strikeOffApproved: true,
  },
  ...
  },
  {
    ...
    fabric: "poly-interlock-matte",
    gsm: 180,
    block: "heritage-tee-v1",
    mode: "none",
    blurb: "Garnet body. Bone panels. Bayonne script and 1936 on the chest.",
    plateFront: "heritage-tee-garnet",
    plateSecondary: "heritage-tee-garnet",
    strikeOffApproved: true,
  },
  {
    sku: "BB-HT-B",
    ...
    plateFront: "heritage-tee-black",
    plateSecondary: "heritage-tee-black",
    strikeOffApproved: true,
  },
  {
    sku: "BB-BS-G",
    ...
    fabric: "cotton-poly-fleece",
    gsm: 320,
    block: "baggy-sweats-v1",
    mode: "none",
    blurb: "Wide garnet fleece. Crest on the thigh. 1936 down the leg.",
    plateFront: "baggy-sweats-garnet",
    plateSecondary: "baggy-sweats-garnet",
    strikeOffApproved: true,
  },
  {
    sku: "BB-BS-B",
    ...
    plateFront: "baggy-sweats-black",
    plateSecondary: "baggy-sweats-black",
    strikeOffApproved: true,
  },
  {
    sku: "BB-SCARF",
